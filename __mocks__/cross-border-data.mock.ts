          ...
          mainDataSetBase: {
            ...
            columns: [
              ...
              },
              {
                ...
                expressionType: 'simple_expression',
                expressionOptions: {
                  expression: 'IF(hmsd.is_suppressed_this_month = 1 and hmsd.is_cross_border_this_month = 1 , 1 , 0)',
                },
              },
              {
                type: 'derived_column',
      ...
      report: {
        ...
        reportSchemas: {
          main: {
            ...
            groupBy: {
              groupParam: 'groupByParam',
              columns: ['arv_first_regimen_location_id', 'age_range', 'hmsd.gender'],
              excludeParam: 'excludeParam',
            },
            transFormDirectives: {
              joinColumn: 'location_id',
  ...
  sectionDefinitions: [
    {
      ...
      indicators: [
        ...
        },
        {
          ...
          ref: 'HV03-009',
          indicator: 'dc__gender__M__age_range__older_than_24__enrolled_this_month',
        },
        {
          label: 'Enrolled in care - 25yrs and older(F)',
          ref: 'HV03-010',
          indicator: 'dc__gender__F__age_range__older_than_24__enrolled_this_month',
        },
        {
    ...
    {
      sectionTitle: '3.4 Currently on ART [ALL] - (Add 3.2 and 3.3 e.g HV03-34=HV03-20+HV03-28)',
      indicators: [
        {
